...
-- -----------------------------------------------------
-- Placeholder table for view `cotonet-test`.`conflict_collaborations_per_merge_scenario_filechunk`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cotonet-test`.`conflict_collaborations_per_merge_scenario_filechunk` (`'system'` INT, `'ms.id'` INT, `'devA'` INT, `'devB'` INT, `'range'` INT, `'filepaph'` INT);

-- -----------------------------------------------------
-- View `cotonet-test`.`conflict_collaborations_per_merge_scenario_filechunk`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `cotonet-test`.`conflict_collaborations_per_merge_scenario_filechunk` ;
DROP TABLE IF EXISTS `cotonet-test`.`conflict_collaborations_per_merge_scenario_filechunk`;
USE `cotonet-test`;
CREATE  OR REPLACE VIEW `conflict_collaborations_per_merge_scenario_filechunk` AS
select 
	s.name 'system', 
    ms.id 'ms.id',
    e.dev_a 'devA',
...
join merge_scenarios ms on n.merge_scenario_id = ms.id
